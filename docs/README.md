...
- **情シス運営**：社内NW・機器管理・ベンダー折衝・ヘルプデスクまで一貫対応
...
### プロジェクトD：社内情シス業務全般（情報システム部部長兼エンジニア）
- **背景**：複数社で情シス専任者が少ない環境のもと、情報システム部の部長兼エンジニアまたは1人情シスとして、インフラからヘルプデスクまで幅広い情シス業務を担当
- **取り組み**
  - **社内ネットワーク構築・運用**：社内LAN設計・構築・保守、通信機器の管理とトラブル対応
  - **ベンダー折衝・マネジメント**：外部ベンダーへの発注管理、提案内容・価格の妥当性評価、コスト適正化交渉
  - **PC・機器の調達・リース管理**：端末・サーバー・周辺機器のリース契約管理、更新タイミングの計画と対応
  - **ヘルプデスク・社内サポート**：社員からの問い合わせ対応、PC設定・トラブルシューティング
- **成果**：少人数体制での情シス部門を安定稼働、ベンダー管理とコスト適正化を推進
...
- **株式会社D（2023/10〜2024/11）**：情報システム部部長兼エンジニア。社内NW構築・運用、ベンダー折衝・コスト適正化、PC・機器調達・リース管理、ヘルプデスク対応、組織マネジメント、予算管理、人材育成、クラウド運用、AI活用推進、社内ツール統合
- **株式会社C（2022/01〜2023/07）**：IoT通信・SRE、IaC、コスト管理、技術発信（Blog立ち上げ）、社内NW管理、PC・スマホ等業務端末管理、社内SaaS運用・新規廃止検討（1人情シス兼務）
- **株式会社B（2018/12〜2022/01）**：オンプレ→AWS移行、SaaS最適化、産学連携PJ
- **株式会社A（2001/04〜2018/10）**：携帯ネットワークエンジニア／商品企画、MVNO立ち上げ
