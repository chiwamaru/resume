...
<div style="display:flex; align-items:center; gap:1.5rem; margin-bottom:1.5rem;">
  ...
  <div>
    ...
    <p>GCP / AWS を中心に、インフラ担当不在からの立ち上げや、属人化・混在した環境の技術的な現状調査・優先度判断・標準化の方針策定から、Terraform / IaC 化・SRE 的な運用設計改善の実装・定着まで一気通貫で担当します。20 年以上の経験をもとに、スタートアップや成長フェーズの組織で「技術的に正しい現実解を設計し、自分で実装して定着させる」役割を担っており、日本をよくしようと挑戦しているチームをインフラ・クラウド基盤の側面から支えていきたいと考えています。</p>
