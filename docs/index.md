...
- **AWS 設計・構築・運用改善：** BIGLOBE での CCoE 活動・約 200 サービスの AWS 移行推進・設計レビュー・ガイドライン整備を経験
...
| AWS | EC2, S3, IAM, VPC, Route 53, Lambda, Bedrock, RDS, CloudWatch, CloudFormation, AWS Organizations, Cost Explorer, AWS Budgets, WAF, ELB / ALB | CCoE / AWS 移行支援 / 設計レビュー / 社内相談対応を経験 |
