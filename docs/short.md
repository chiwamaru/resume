...
スタートアップや成長フェーズの組織で、インフラ担当が不在の段階からの立ち上げや、複数プロダクト・チームが混在してカオス化した環境の整理立て直しを担いながら、開発チームが機能開発に集中できる基盤をつくる仕事をしてきました。属人化・権限管理・コスト可視化といった「今急がないが後で必ず困る領域」に早めに手を入れることを大切にしてきました。
