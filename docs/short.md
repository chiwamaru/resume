...
スタートアップや成長フェーズの組織で、インフラ担当が不在の段階からの立ち上げや、複数プロダクト・チームが混在してカオス化した環境の整理立て直しを担いながら、開発チームが機能開発に集中できる基盤をつくる仕事をしてきました。属人化・権限管理・コスト可視化など、後回しにされやすいものの将来的にボトルネックになりやすい領域について、早期に整理・改善していくことを重視してきました。
